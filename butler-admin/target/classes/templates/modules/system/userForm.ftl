                 		...
                 		<label  class="am-u-sm-3 am-form-label">头像</label>
                  		<div class="am-u-sm-9">
                  			<div class="am-input-group am-input-group-sm">
	                       		<input autocomplete="off" class="uploadFile" uploadType="image" type="text" id="headImg" name="headImg" placeholder="用户头像" value="${user.headImage !''}" readonly="readonly">
                	...
                	<div class="am-form-group">
                 		<label  class="am-u-sm-3 am-form-label"><span class="required">*</span>期限</label>
                  		<div class="am-u-sm-9">
                  			<div class="am-input-group am-input-group-sm">
                  				<#if user.startTime??>
                  					<input autocomplete="off" type="text" id="startTime" name="startTime" placeholder="开始时间" value="${user.startTime}" required>
                  				<#else>
                  				...
                  				<#if user.endTime??>
                  					<input autocomplete="off" type="text" id="endTime" name="endTime" placeholder="结束时间" value="${user.endTime}" required>
                  				<#else>
